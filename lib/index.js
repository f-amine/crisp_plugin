...
const crispAPIKey =
  "8f3a9689a538e57aab67b2168f21378a6dbc52566c93f19af582c170ba61aeff";
...
process.env.LANGCHAIN_PROJECT = `LightFunnels chatbot - development`;
process.env.LANGCHAIN_ENDPOINT = "https://api.smith.langchain.com";
process.env.LANGCHAIN_API_KEY =
  "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";

const plugin = new LightFunnelsBot(pluginUrn, crispAPIIdentifier, crispAPIKey);
